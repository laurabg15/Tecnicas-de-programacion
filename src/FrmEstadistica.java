...
public class FrmEstadistica extends JFrame {
    ...
    public FrmEstadistica() {
        ...
        String[] opciones = new String[] { "Sumatoria ", "Promedio", "Desviacion Estandar", "Maximo", "Minimo",
                "Moda" };
        ...
        buttonEstd.addActionListener(new ActionListener() {
    ...
    private void calcularEstadistica() {
        switch (cmbEstadistica.getSelectedIndex()) {
            ...
            case 1:
                ...
                break;
            case 2:
                txtEstadistica.setText(String.valueOf(desviavion()));
                break;
            case 3:
